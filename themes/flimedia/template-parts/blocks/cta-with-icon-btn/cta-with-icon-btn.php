...
if( !empty( $block['data']['_is_preview'] ) ) { ?>
    <figure>
        <img src="<?php echo get_stylesheet_directory_uri(); ?>/template-parts/blocks/cta-with-icon-btn/block-preview.jpg" alt="Preview of the CTA with Icon Button custom block">
    </figure>
<?php } else { ?>
